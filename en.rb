...
{ :language => 'english',
  ...
  :indexTitle => "Welcome in Lorraine ...",
  :indexContent1 => "In the heart of the Lorraine country, you will have a warmfull and friendly welcome at the Auberge Aux Trois Marcassins.",
  :indexContent2 => "In a chic and discreet atmosphere, take the time to discover or rediscover the delicious french countryside cooking ...",
  :indexContent3 => "... and take some rest in our wide and delightful rooms.",

  :restoTitle => "Authenticity",
  :restoSubTitle1 => "... for your taste ...",
  :restoContent1 => "In a typical lorrain house, under visible beams, enjoy Mr. and Ms. Bourgau traditional and characterful cooking.",
  :restoSubTitle2 => "... at the rythm of seasons ...",
  :restoContent2 => "Our passionate Chef, uses its imagination all year long to adjusts his menus according to the products of the moment.",
  :restoContent3 => "Game, during the hunting season, is invited to the menu.",
  :restoContent4 => "Formely sommelier in a french Restaurant in London, our chef can help you to choose the best wines from a wide selection.",
  :restoContent5 => "Everything here is authentic, even the desserts, home made by our chef's wife.",
  ...
  :hotelContent2 => "From one to four people, you are welcome in our rooms that are equiped with a en-suite bathroom, toilet, telephone, TV and free access Wifi.",
